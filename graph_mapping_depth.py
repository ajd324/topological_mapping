...
def image_callback(img_msg):
    ...
    try:
        ...
        if take_picture == True:
            cv2.imwrite("/home/agilex/topological_mapping/images/depth_image_" + str(num_nodes) + ".png", color_img)
            take_picture = False
...
"""
    ...
    while(run):
	    ...
	    num_nodes+=1
            x_temp = x_pose
            y_temp = y_pose
            graph_map.add_node(num_nodes, x_pose=x_temp, y_pose=y_temp, color_img="/home/agilex/topological_mapping/images/depth_image_" + str(num_nodes) + ".png")
            take_picture = True
